...
import dev.joseluisgs.pokedexfx.controllers.PokedexViewConroller
...
object RoutesManager {
    ...
    fun initMainStage(stage: Stage) {
        ...
        stage.icons.add(Image(getResourceAsStream("icons/pokedex.png")))
        stage.setOnCloseRequest {
            // Podemos hacer algo antes de cerrar
            // println("Cerrando la ventana")
            val controller = fxmlLoader.getController<PokedexViewConroller>()
