...
import dev.joseluisgs.moscafx.controllers.MoscaViewConroller
...
object RoutesManager {
    ...
    fun initMainStage(stage: Stage) {
        ...
        val scene = Scene(parentRoot, 875.0, 350.0)
        // scene.stylesheets.add(getResource(Style.DAM.css).toExternalForm())
        stage.title = "La Mosca: El Juego"
        ...
        stage.setOnCloseRequest {
            ...
            val controller = fxmlLoader.getController<MoscaViewConroller>()
